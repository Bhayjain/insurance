...
var admin_data = JSON.parse(Cookies.get('admin_data'));
var user_management_view = Cookies.get('user_management_view');
var admin_management_view = Cookies.get('admin_management_view');
var recuritement_view = Cookies.get('recuritement_view');
var agent_management_view = Cookies.get('agent_management_view');
var support_management_view = Cookies.get('support_management_view');
var sales_management_view = Cookies.get('sales_management_view');
var sales_management_control = Cookies.get('sales_management_control');
var opeartion_dock_view = Cookies.get('opeartion_dock_view');
var policy_dock_view = Cookies.get('policy_dock_view');
var accounting_view = Cookies.get('accounting_view');
var cheque_report_view = Cookies.get('cheque_report_view');
var reporting_view = Cookies.get('reporting_view');
var master_view = Cookies.get('master_view');
var deviation_dock_view = Cookies.get('deviation_dock_view');
var pending_payment_view = Cookies.get('pending_payment_view');
var time_tracker_view = Cookies.get('time_tracker_view');
var customer_cheque_view = Cookies.get('customer_cheque_view');
var endorsement_view = Cookies.get('endorsement_view');


var operation_page = Cookies.get('operation_page');
var telecaller_app_page = Cookies.get('telecaller_app_page');
var payments_page = Cookies.get('payments_page');
var reports_page = Cookies.get('reports_page');
var accounting_page = Cookies.get('accounting_page');
var time_tracker_page = Cookies.get('time_tracker_page');
var employee_page = Cookies.get('employee_page');
var master_page = Cookies.get('master_page');
var payroll_page = Cookies.get('payroll_page');
var contacts_view = Cookies.get('contacts_view');
var reference_user_view = Cookies.get('reference_user_view');
var campaign_view = Cookies.get('campaign_view');
var dashboard_app_view = Cookies.get('dashboard_app_view');
var payroll_view = Cookies.get('payroll_view');
var dashboard_payroll_view = Cookies.get('dashboard_payroll_view');
var attendance_view = Cookies.get('attendance_view');
var leave_request_view = Cookies.get('leave_request_view');
var loans_view = Cookies.get('loans_view');
var allowance_view = Cookies.get('allowance_view');
var genral_report_view = Cookies.get('genral_report_view');
...
//console.log(payroll_page, "payroll_page***************************************************");
...
class Content extends Component {
    constructor( props ) {
        ...
        this.state = {
            ...
            termsError: '',
            loading: false,
            show_home_module:admin_data[0].show_home_module,
            show_home_module_msg:admin_data[0].show_home_module_msg
        };
        ...
        this.setState(() => {
            ...
            setTimeout(() => {
                    ...
                    if (id == "operation_page"){
                        ...
                        }else if(admin_management_view == "true"){
                        ...
                        if (dashboard_payroll_view == "true") {
                            location.hash = "/payroll-dashboard"
                        }
                       else if(payroll_view == "true"){
                            location.hash = "/salaries"
                        }
                       else if(attendance_view == "true"){
                            location.hash = "/attendance"
                        }
                       else if(leave_request_view == "true"){
                            location.hash = "/requested-leave"
                        }
                       else if(loans_view == "true"){
                            location.hash = "/loans"
                        }
                       else if(allowance_view == "true"){
                            location.hash = "/allowance"
                        }
                       else if(genral_report_view == "true"){
                            location.hash = "/payroll-report"
                        }
                    }
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <div className="container margin_down mycalendar" style={{height:height}}>
                ...
                <div className="row ttt" id="home_page">
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 ss" style={{ marginBottom: "10px", display: operation_page == "true" ? "block" : "none" }}>
                            <Card onClick={() => { this.select_project("operation_page") }} id="operation_page" className="card_ratio" style={{ background: "#1450A3" }}>
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 ss" style={{ marginBottom: "10px", display: telecaller_app_page == "true" ? "block" : "none" }}>
                            <Card onClick={() => { this.select_project("telecaller_app_page") }} id="telecaller_app_page" className="card_ratio" style={{ background: "#279EFF" }}>
                 ...
                 <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 ss" style={{ marginBottom: "10px", display: payroll_page == "true" ? "block" : "none" }}>
                            <Card onClick={() => { this.select_project("payroll_page") }} id="payroll_page" className="card_ratio" style={{ background: "#164B60" }}>
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 ss" style={{ marginBottom: "10px", display: payments_page == "true" ? "block" : "none" }}>
                            <Card onClick={() => { this.select_project("payments_page") }} id="payments_page" className="card_ratio" style={{ background: "#4c5a81" }}>
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 ss" style={{ marginBottom: "10px", display: accounting_page == "true" ? "block" : "none" }}>
                            <Card onClick={() => { this.select_project("accounting_page") }} id="accounting_page" className="card_ratio" style={{ background: "#6693f5" }}>
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 ss" style={{ marginBottom: "10px", display: time_tracker_page == "true" ? "block" : "none" }}>
                            <Card onClick={() => { this.select_project("time_tracker_page") }} id="time_tracker_page" className="card_ratio" style={{ background: "#213363" }}>
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 ss" style={{ marginBottom: "10px", display: employee_page == "true" ? "block" : "none" }}>
                            <Card onClick={() => { this.select_project("employee_page") }} id="employee_page" className="card_ratio" style={{ background: "#6F61C0" }}>
                              <h3 className="heading_title_new">HRM</h3>
                                <div className="image_center">
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 ss" style={{ marginBottom: "10px", display: reports_page == "true" ? "block" : "none" }}>
                            <Card onClick={() => { this.select_project("reports_page") }} id="reports_page" className="card_ratio" style={{ background: "#4E4FEB" }}>
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 ss" style={{ marginBottom: "10px", display: master_page == "true" ? "block" : "none" }}>
                            <Card onClick={() => { this.select_project("master_page") }} id="master_page" className="card_ratio" style={{ background: "#1D5D9B" }}>
                 ...
                 <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 " style={{display:this.state.show_home_module == false ? "block" : "none",marginTop:(height/3)-20}}>
                     <p className="false_message_sign">{this.state.show_home_module_msg}</p>
                 </div>
                </div>
