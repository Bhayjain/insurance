...
class Content extends Component {
    ...
    add_role = () => {
        ...
        // if (this.state.payroll_view == false  ) {
            ...
            <Fragment>
              <PageTitle className="admin_title">
                  <div style={{width:"100%",display:"inline-flex"}}>
                    ...
                    <Button id="add_role" className="toppp_neeee" color="warning" disabled={this.state.master_control_12 =="false" ? 'disabled' : ''} style={{backgroundColor:"#8bc240" ,borderColor:"#8bc240",color:"#fff",textTransform:"capitalize",marginLeft:"auto"}} onClick={ this.toggle }>Add Role</Button>
                    </div>
                </PageTitle>
                ...
                <div className="row top_roqwww" style={{display: this.state.isLoading=="none" ? "flex" :"none"}}>
                            ...
                            <tbody>
                              {
                                this.state.role_array.map((value12, index12) => {
                                  return (
                                    ...
                                    >
                                      <td className="strip_paded admin_role_name"  style={{ borderLeft: value12._id == this.state.role_id ? "5px solid  #8bc240" : " 0px", verticalAlign: "middle",padding:"10px 25px" }} >{value12.role_name}</td>
                                     </tr>
                                  )
                                })
                              }
                        ...
                        <div style={{display:this.state.spinner_1=="none" ? "block":"none"}}>
                            ...
                            <div className="col-lg-6 col-md-12 col-sm-12">
                                ...
                                <div className="col-lg-12 col-md-12 col-sm-12" style={{ display: "inline-flex",marginBottom:"5px" }}>
                                      <div className="mobile desi page_module_new" style={{whiteSpace: "nowrap" ,width: "160px"}}>Employees</div>:
                                      <span style={{ marginLeft: "23px" }}>
                                      <div className="forSmallDevices2 new_page_module">
                                        <div style={{ marginRight: '0px' }}>
                                            <CustomInput
                ...
                <Modal
                    ...
                    >
                           ...
                           <div className="row">
                               ...
                               {/* Payroll Acees */}
                                 {/* <div className="col-lg-6 col-md-12 col-sm-12">
                                    ...
                                    <div className="col-lg-12 col-md-10 col-sm-12" style={{ display: "inline-flex" }}>
                                       <div className="mobile desi" style={{ width: "160px", whiteSpace: "nowrap" }}>Payroll</div>:
                                       <span style={{ marginLeft: "30px",display: "inline-flex" }}>
                                       <Label>
                                       <div className="forSmallDevices2"><div style={{ marginRight: '0px' }}>
                                            <CustomInput
                        ...
                        <ModalFooter>
                            ...
                            { ' ' }
                            <Button color="warning" style={{backgroundColor:"#8bc240" ,borderColor:"#8bc240",color:"#fff",textTransform:"capitalize"}} onClick={ this.switch_function } id="save_role">{this.state.button_admin}</Button>
                        </ModalFooter>
                    </Modal>
