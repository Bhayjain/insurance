 ...
 class Content extends Component {
     ...
     fetch_all_daily_sales_report = (startDate,endDate,pageNumber)=>  {
         ...
         const { settings } = this.props;
          const res = fetch(settings.api_url + "fetch_investmentwise_monthly_business_report", {
              method: 'POST',
              ...
              .then(json => {
                  //console.log("fetch Investment Report ****", json)
                  var data = json;
                  if (data.status == true) {
                      this.setState({
                          ...
                          total_po_payout:data.total_po_payout,
     ...
     daily_sales_report = ()=>  {
        ...
        //console.log("Export Params",params);
          const res = fetch(settings.api_url + "export_investmentwise_monthly_business_report", {
              method: 'POST',
              body: JSON.stringify(params),
              headers: {
                  "Content-type": "application/json; charset=UTF-8",
                 ...
                 <Table striped>
                         <thead>
                             <tr>
                                 ...
                                 <th scope="col" className="table_head_new" style={{textAlign:"end"}}>Amount Receivable</th>
                                 ...
                                 <th scope="col" className="table_head_new" style={{textAlign:"end"}}>PO (Payout)</th>
                                 <th scope="col" className="table_head_new" style={{textAlign:"end"}}>Investment</th>
                             </tr>
                         </thead>
                         <tbody>
                             {this.state.daily_sales_array.map((value,index)=>{
                                 ...
                                 return(
                                     ...
                                     <td className="table_sub_head" style={{textAlign:"end"}}>&#x20b9; {value.po_payout}</td>
                                     <td className="table_sub_head" style={{textAlign:"end"}}>&#x20b9; {value.investment}</td>
                                 </tr>
                                 )
                             })}
                              <tr >
                                     ...
                                     <td className="table_sub_head total_new" style={{textAlign:"end"}}>&#x20b9; {this.state.total_po_payout}</td>
