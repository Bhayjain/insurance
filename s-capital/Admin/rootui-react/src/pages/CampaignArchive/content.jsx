        ...
        const { settings } = this.props;
         const res = fetch(settings.api_url + "api/telecaller_app/fetch_campaigne_type", {
          ...
          fetch_compaign_details = (search_by_name,search_by_type)=>  {
            ...
            const { settings } = this.props;
             const res = fetch(settings.api_url + "api/telecaller_app/fetch_compaign_details_for_deleted", {
                 method: 'POST',
                 body: JSON.stringify(params),
                 headers: {
                     "Content-type": "application/json; charset=UTF-8",
                 ...
                 .then(json => {
                     ...
                     if (data.status == true) {
                         this.setState({
                          ...
                          campaign_id: "",
                          campaign_name: "Archived Campaigns",
                          isLoading:false,
                          no_data:"none",
                          spinner_1:"none",
                          show_nav_titile:false,
      ...
      delete_campaign(campaign_id) {
            ...
            const {addToast,settings} = this.props;
                ...
                console.log("Delete params************",params);
                  const res = fetch(settings.api_url + "api/telecaller_app/permanent_delete_campaign", {
                      method: 'POST',
                      body: JSON.stringify(params),
                      headers: {
                          "Content-type": "application/json; charset=UTF-8",
              ...
              const { settings,addToast } = this.props;
               const res = fetch(settings.api_url + "api/telecaller_app/fetch_contacts_for_all_for_deleted", {
                   method: 'POST',
                //    body: JSON.stringify(params),
                   headers: {
                       "Content-type": "application/json; charset=UTF-8",
              ...
              const { settings,addToast } = this.props;
               const res = fetch(settings.api_url + "api/telecaller_app/fetch_campaign_status_for_deleted", {
                   method: 'POST',
                //    body: JSON.stringify(params),
                   headers: {
                       "Content-type": "application/json; charset=UTF-8",
                      ...
                      if (scrollOffset <= containerHeight + 20 && compaign_Call_array_lenth >= 20 && this.state.is_last == false) { // 20 is the threshold for triggering the fetch
                        ...
                        //   console.log("@@@@@@@@@@@@@@@@@@@@@@@");
                          ...
                          setTimeout(()=>{
                            ...
                            this.fetch_campaign_call_logs(this.state.campaign_id,this.state.search_by_telicller,this.state.startDate,this.state.endDate, this.state.current_page)
                            },0)
                      }
                    };
        ...
        return (
            <Fragment>
                 <PageTitle className = "cam_haeding">
                    <div className="row">
                        <div className={this.state.ipad_emp_list == "block" ? "col-lg-6 col-md-10 col-sm-12" :"col-lg-6 col-md-12 col-sm-12"}  style={{paddingLeft:"9px"}}>
                        <div style={{display:"inline-flex",width:"100%"}}>
                            <div style={{display:this.state.show_nav_titile == true ? "block" :"none"}}>
                                <div className="tooltip_poo_back_1" aria-hidden="true" onClick={ () => {
                            ...
                            <h1 style={{marginTop:"-1px",width :this.state.campaign_name.length > 20 ? "285px" : "",textTransform:"capitalize"}} className={this.state.campaign_name.length > 20 ? "marquee" : ""} >
                                <span style={{whiteSpace:"nowrap"}}>{this.state.isLoadingForSingle ? "Archived Campaigns" : this.state.campaign_name }</span>
                                </h1>
                       ...
                       {/*  for taskkk sorting  */}
                        ...
                        <div className={this.state.ipad_emp_list == "block" ? "col-lg-6 col-md-2 col-sm-12":"col-lg-6 col-md-12 col-sm-12 mar_top_cam" }  style={{textAlign:"end",textTransform: "capitalize"}}>
                        ...
                        {/* <Button color="warning" disabled={this.state.campaign_control == "false" ? 'disabled' : ''} style={{color:"#fff",textTransform:"capitalize",whiteSpace:"nowrap",padding:"9px 9px",height: "34px",paddingTop:"8px"}} onClick={this.toggle}>Back</Button> */}
                        <Button color="secondary" style={{color:"#fff",textTransform:"capitalize",whiteSpace:"nowrap",padding:"9px 9px",height: "34px",paddingTop:"8px",marginLeft:"0px",backgroundColor:"#0B666A",borderColor:"#0B666A"}} onClick={()=>this.redirect_to_archive()}>Back to Campaigns</Button>
                        <div className="width_of_delete tool_tip_delete" style={{display:this.state.show_nav_titile == true ? "block" :"none"}}>
                            <Button  disabled={this.state.campaign_control == "false" ? 'disabled' : ''} color="danger" style={{padding:"7px 11px",textTransform:"capitalize",height:"34px",marginLeft:"auto"}} onClick={()=>{
                             ...
                             <span className="delete_camp_tool">Delete Campaign</span>
                            </div>
                        <div style={{display: device_width < 769 ? this.state.ipad_width : "block"}}>
                        <Button color="info" className="backk_btnnn" style={{ textTransform:"capitalize", display: device_width < 769 ? "block" : "none",marginLeft:"17px"}}
                                    onClick={() => {
                                    this.setState({
                                        ipad_emp_list:"block",
                                        ipad_width:"none",
                          ...
                          <div className="col-lg-12 col-md-12 i_pad_data" style={{paddingLeft:"0px"}}>
                              ...
                              <div>
                                    ...
                                    <div className="heading_opeartion padding_newww" style={{padding:"1px"}}>
                                       <div className=" mycalendar" style={{height:my_height-91,padding:"10px 6px"}}>
                                    ...
                                    <Tabs.Pane tabId="details">
                                                ...
                                                <div className="box_data_cam mycalendar" style={{height:my_height-91}}>
                                                    <div className="row margin_top_new_neee test_collapse">
                                                         <div className="col-lg-12 col-md-12" style={{display:"inline-flex",width:"100%",justifyContent:"space-between"}}>
                                                            ...
                                                            <div style={{display:"inline-flex"}}>
                                                            <CustomInput checked={this.state.array_of_single_campaign.pause == true ? true : false} type="switch" id="formSwitch1" name="formSwitch1" />
                                                            <Button  disabled={this.state.campaign_control == "false" ? 'disabled' : ''} color="danger" style={{padding:"7px 11px",textTransform:"capitalize",height:"32px",marginLeft:"auto",marginTop:"-4px"}} onClick={()=>{
                                                                this.setState({
                                                                    AlertDelete2: true,
                                                                    campaign_id:this.state.campaign_id
                                                                })
                                                              ...
                                                              <div className="table-responsive-lg scroll_1 test_collapse " style={{marginBottom:"20px"}} >
                                                                <Table striped>
                                                                    ...
                                                                    {this.state.compaign_task_today_array.map((value,index)=>{
                                                                        ...
                                                                        <td className="camp_table" style={{whiteSpace:"nowrap"}}>{value.follow_up_date_new}</td>
                                                                        ...
                                                                        <td className="camp_table">{value.tags.label ? value.tags.label : value.tags}</td>
                                                        ...
                                                        <div className="table-responsive-lg scroll_1 test_collapse " style={{marginBottom:"20px"}} >
                                                         <Table striped>
                                                                    ...
                                                                    {this.state.compaign_task_overdue_array.map((value,index)=>{
                                                                        ...
                                                                        <td className="camp_table" style={{whiteSpace:"nowrap"}}></td>
                                                                        <td className="camp_table">{value.remark}</td>
                                                                        <td className="camp_table">{value.telecaller_name}</td>
                                                                        <td className="camp_table">{value.tags.label ? value.tags.label : value.tags}</td>
                                                                        <td className="camp_table" >{value.status == undefined ? "Incomplete" : value.status}</td>
                                        ...
                                        <Spinner color="warning" className="employee_spinner_1" style={{ marginTop: gk, display: this.state.spinner_1 }} />
                                          ...
                                          <div className=" test_collapse heading_opeartion" style={{display: this.state.isLoadingForSingle==false ? "block":"none",paddingLeft:"8px",paddingRight:"26px"}}>
                                              ...
                                              <div className="table-responsive-lg scroll_1 test_collapse " >
                                                  <Table striped>
                                                                  ...
                                                                  {this.state.compaign_Call_array.map((value,index)=>{
                                                                      ...
                                                                      <td className="camp_table" style={{whiteSpace:"nowrap"}}>{value.start_time == "" ? "" : dateFormat(new Date(value.start_time.replace("Z", "")), "dd-mm-yyyy h:MM TT")}</td>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="show_status_data_new" style={{marginTop:"4px"}}>
                                                       ...
                                                       <div style={{display:"grid"}}>
                                                            ...
                                                            <span style={{marginLeft:"10px",color:"#33F6FF",fontWeight: "700"}}>{this.state.total_ongoing}</span>
                                                            </div>
                                                            <div style={{display:"inline-flex"}}>
                                                            <div style={{width:"70px"}}>Called</div>:
                                                            <span style={{marginLeft:"10px",color:"#3383FF",fontWeight: "700"}}>{this.state.called_ongoing}</span>
                                                            </div>
                                                            <div style={{display:"inline-flex"}}>
                                                            <div style={{width:"70px"}}>Follow up</div>:
                                                            <span style={{marginLeft:"10px",color:"#FF0036",fontWeight: "700"}}>{this.state.follow_up_ongoing}</span>
                                                            </div>
                                                            <div style={{display:"inline-flex"}}>
                                                            <div style={{width:"70px"}}>Others</div>:
                                                            <span style={{marginLeft:"10px",color:"#770000",fontWeight: "700"}}>{this.state.others_ongoing}</span>
                                                            </div>
                                                     </div>
                                                    </div>
                                                    <h3 style={{ display: this.state.called_ongoing == 0 && this.state.follow_up_ongoing == 0 && this.state.others_ongoing == 0 ? "block" : "none", padding: "15px",textAlign:"center",color:" #a4a3a3",width: "100%",marginTop:"80px"}}>No Data Found</h3>

                                                     <div className="chartContainer_1" style={{marginTop:"-41px",display: this.state.called_ongoing == 0 && this.state.follow_up_ongoing == 0 && this.state.others_ongoing == 0 ? "none" : "block"}}>
                                                        <Pie
                                                            style={{width:"250px",height:"250px"}}
                                                            height={250} width={250}
                                                            data={onging_calss}
                                                    ...
                                                    <div className="show_status_data_new" style={{marginTop:"4px"}}>
                                                       ...
                                                       <div style={{display:"grid"}}>
                                                            <div style={{display:"inline-flex"}}>
                                                            <div style={{width:"75px"}}>Total</div>:
                                                            <span style={{marginLeft:"10px",color:"#5F264A",fontWeight: "700"}}>{this.state.total_closed}</span>
                                                            </div>
                                                            <div style={{display:"inline-flex"}}>
                                                            <div style={{width:"75px"}}>Converted</div>:
                                                            <span style={{marginLeft:"10px",color:"#0A4D68",fontWeight: "700"}}>{this.state.converted_closed}</span>
                                                            </div>
                                                            <div style={{display:"inline-flex"}}>
                                                            <div style={{width:"75px"}}>Lost</div>:
                                                            <span style={{marginLeft:"10px",color:"#F45050",fontWeight: "700"}}>{this.state.lost_closed}</span>
                                                            </div>
                                                     </div>
                                                     </div>
                                                     ...
                                                     <h3 style={{ display: this.state.converted_closed == 0 && this.state.lost_closed == 0 ? "block" : "none", padding: "15px",textAlign:"center",color:" #a4a3a3",width: "100%",marginTop:"80px"}}>No Data Found</h3>
                                                     <div className="chartContainer_1" style={{marginTop:"-41px",display: this.state.converted_closed == 0 && this.state.lost_closed == 0  ? "none" : "block"}}>
                                                        <Pie
                                                            style={{width:"250px",height:"250px"}}
                                                            height={250} width={250}
                                                            data={closed_data}
