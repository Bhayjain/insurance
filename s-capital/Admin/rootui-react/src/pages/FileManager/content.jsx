    ...
    switch_function(){
     ...
     fetch_designation() {
       ...
       for_edit(x){
           ...
           if (x.date_of_birth == "" || x.date_of_birth == null || x.date_of_birth == undefined) {
               var date_of_birth = ""
           }else{
            var date_of_birth = new Date(x.date_of_birth)
           }
         ...
         this.setState({
           ...
           alternate_mobile_no:x.alternate_no,
           email_id_emp:x.email_id,
           gendarType:x.gendarType,
           pf_no:x.pf_no,
           pf_uan:x.pf_uan,
           esic_no:x.esic_no,
           ...
           employment_id_change:x.employment_id,
       ...
       edit_Admin(){
         ...
         if (this.state.employment_id_change == this.state.employment_id ) {
                var employment_id = this.state.employment_id
                var employment_id_update = false
         }else{
            var employment_id = this.state.employment_id
            var employment_id_update = true
         }
         if (this.state.add_relation==true) {
             var relationship_manager=this.state.relation_type
         }
         ...
         var params = {
           ...
           already_uploaded_profile_picture:already_uploaded_profile_picture,
            ...
            employment_id_update:employment_id_update,
         }
         console.log("edit===========", params);
         if(params.name == "" || params.name == undefined || params. mobile_no == "" || params. mobile_no == undefined || params.password == "" || params.password == undefined || params.date_of_birth == "" | params.date_of_birth == undefined ||  params.employment_id == "" | params.employment_id == undefined ){
            this.setState({
                error_meesage:"Please Fill all the field",
                borderNew:true
            })
              ...
              .then(json => {
                  ...
                  if (data.status == true) {
                    if (device_width < 769) {
                       ...
                       if(data.data[0].prospect_id !== undefined && data.data[0].prospect_id !== '' && data.data[0].prospect_id !== null){
                         var prospect_id = data.data[0].prospect_id
                         this.fetch_single_prospect(prospect_id)
                       }else{
                         var prospect_id = ''
                       }
                      this.setState({
     ...
     fetch_all_letter_template = ()=>  {
        ...
        uploadImage = async (e) => {
          ...
          add_engagement=()=>{
            ...
            if (this.state.engagement_type == "" || this.state.engagement_type == undefined || this.state.designation_type == "" || this.state.designation_type == undefined  || this.state.salary_structure_obj == "" || this.state.salary_structure_obj == undefined) {
                this.setState({
        ...
        fetch_single_interview_deatils=(value)=>{
            ...
            this.setState({
              ...
              req_date_of_assigning :value.assiging_date ?  new Date(value.assiging_date) : new Date(),
              req_engagement_type:value.letter_template,
              req_salary_emp:value.salary_amount,
              req_salary_structure_obj:value.salary_structure,
             ...
             <Spinner color="warning" className="spinner_css_12345" style={{marginTop:gk,display: this.state.isLoading}}/>
                 ...
                 <h3 style={{ display: this.state.no_data_message, padding: "15px",textAlign:"center",color:" #a4a3a3",width: "100%",marginTop:gk}}>No Data Found</h3>
                              ...
                              return (
                                <tr style={{cursor:"pointer"}}  key={index} onClick={() => {
                                 this.setState({
                                    ...
                                    <td  style={{verticalAlign:"middle",padding:"10px 16px",borderLeft:this.state.user_id == value._id ? "5px solid #007bff" :""}}>
                  ...
                  <div style={{display:this.state.total_pages_emp==1?"none":'inline-flex',width:"100%",marginTop:"2px",marginBottom:"-1px",padding: "1px 8px"}}>
                            ...
                            <div className="test_collapse pad_in_dar mycalendar" style={{display:this.state.pending_spinner=="none" ? "block" : "none",height:my_height-68}}>
                            ...
                            {this.state.single_pending_array.map((value,index)=>{
                                    ...
                                    let y =index;
                                     ...
                                     <Button className="" style={{ marginLeft: "5px",  backgroundColor: '#007bff', borderColor: '#007bff',textTransform:"capitalize", display: device_width < 769 ? "inline-flex" : "none",paddingTop:" 5px"}}
                                                 ...
                                                 <div className="row">
                                                    <div className="col-lg-12 col-md-12 col-xs-12 inputHeight" style={{marginTop:"20px",paddingRight:"30px"}}>
                                                    <div className="accordion-group">
                                                            ...
                                                            <Collapse isOpen={ 1 === activeAccordion }>
                                                                <div className="collapse-content employeeCollapseData">
                                                                        ...
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.date_of_birth == ""  || value.date_of_birth == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">DOB</div>
                                                                            <div className="bottom_value">{value.date_of_birth !="" && value.date_of_birth!=undefined ?  value.date_of_birth.split("-")[2] + "-" + value.date_of_birth.split("-")[1] + "-" + value.date_of_birth.split("-")[0]  :""}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.alternate_no == "" || value.alternate_no == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">Alternate Mobile Number</div>
                                                                            <div className="bottom_value">{value.alternate_no}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.email_id == "" || value.email_id == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">Email ID</div>
                                                                            <div className="bottom_value">{value.email_id}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.gendarType == ""  || value.gendarType == undefined? "none" : "block"}}>
                                                                            <div className="top_value">Gender</div>
                                                                            <div className="bottom_value" style={{textTransform:"capitalize"}}>{value.gendarType}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.address == "" || value.address == undefined ? "none" : "block"}}>
                                                    ...
                                                    <div className="accordion-group">
                                                            ...
                                                            <Collapse isOpen={ 2 === activeAccordion }>
                                                                <div className="collapse-content employeeCollapseData">
                                                                <div className="row">
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.aadhar_number == "" || value.aadhar_number == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">Aadhar Number</div>
                                                                            <div className="bottom_value">{value.aadhar_number}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.pan_number == "" || value.pan_number == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">PAN Number</div>
                                                                            <div className="bottom_value">{value.pan_number}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.un_number == "" || value.un_number == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">UN Number</div>
                                                                            <div className="bottom_value">{value.un_number}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.pf_no == "" || value.pf_no == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">PF Number</div>
                                                                            <div className="bottom_value">{value.pf_no}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.pf_uan == "" || value.pf_uan == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">PF UAN</div>
                                                                            <div className="bottom_value">{value.pf_uan}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.esic_no == "" || value.esic_no == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">ESIC No</div>
                                                                            <div className="bottom_value">{value.esic_no}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.bank_account_number == "" || value.bank_account_number == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">Bank Account Number</div>
                                                                            <div className="bottom_value">{value.bank_account_number}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.ifsc_code == "" || value.ifsc_code == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">IFSC Code</div>
                                                                            <div className="bottom_value">{value.ifsc_code}</div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.branch == "" || value.branch == undefined ? "none" : "block"}}>
                                                                            <div className="top_value">Branch</div>
                                                                            <div className="bottom_value">{value.branch}</div>
                                                                        </div>
                                                                    </div>
                                                                 </div>
                                                            </Collapse>
                                                    ...
                                                    <div className="accordion-group">
                                                            ...
                                                            <Collapse isOpen={ 3 === activeAccordion }>
                                                                <div className="collapse-content employeeCollapseData">
                                                                <div className="row">
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.source_from == "" ? "none" : "block"}}>
                                                                        ...
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.is_relationship_manager == false || value.is_relationship_manager == null ? "none" : "block"}}>
                                                                        ...
                                                                        <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.is_mis_dock_relationship_manager == false || value.is_mis_dock_relationship_manager == null ? "none" : "block"}}>
                                                    ...
                                                    {/* <div className="col-lg-12 col-md-12 col-xs-12 inputHeight" style={{marginTop:"30px"}}>
                                                        <p className="headingForEmpShow"> </p>
                                                            <div className="row">
                                                            <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.aadhar_number == "" || value.aadhar_number == undefined ? "none" : "block"}}>
                                                                <div className="top_value">Aadhar Number</div>
                                                                <div className="bottom_value">{value.aadhar_number}</div>
                                                    ...
                                                    {/* <div className="col-lg-12 col-md-12 col-xs-12 inputHeight" style={{marginTop:"30px"}}>
                                                        <p className="headingForEmpShow">Company Details</p>
                                                         <div className="row">
                                                            <div className="col-lg-4 col-md-4 col-sm-12 mt-10" style={{display:value.source_from == "" ? "none" : "block"}}>
                                                                <div className="top_value">Source from</div>
                                                                <div className="bottom_value">{value.source_from}</div>
                                             ...
                                             <div className="box_data_employee">
                                                 <div className="row" style={{marginTop:"16px"}}>
                                                   ...
                                                   <div className="col-lg-4 col-md-4" style={{textAlign:"end",paddingRight:"30px"}}>
                                                       <Button color="primary" style={{textTransform:"capitalize"}} disabled={ this.state.contacts_control == "false" ? true : false} onClick={()=>{
                                                           this.setState({
                                                            Engagementsmodal:true,
                                                            user_id:value._id
                                                           })
                                             ...
                                             */}
                                             ...
                                             <div className="box_data_employee" style={{ display: this.state.prospect_id == '' ? 'none': 'block'}}>
                                                 <div className="row" style={{marginTop:"16px"}}>
                                                   <div className="col-lg-8 col-md-8">
                                                ...
                                                {this.state.interview_detail.map((val,index)=>{
                                                    return(
                                                        <>
                                                        <Tabs.NavItem
                                                            isActive={ this.state.req_activeTab2 === val._id }
                                                            onClick={ () => {
                                                                this.setState({
                                                     ...
                                                     <Tabs.Content activeTab={ this.state.req_activeTab2 }>
                                                                  ...
                                                                  <div className="col-lg-9 col-md-9">
                                                                        ...
                                                                        <div className="col-lg-12">
                                                                            {this.state.offerTab == "offer" ?
                                                                                    ...
                                                                                    <CustomInput disabled={true} type="radio" id="formRadioOffer1" name="formRadio" label={this.state.offer_status == 'accepted' ? 'Accepted' :'Accept'}  checked={this.state.offer_status === "accepted"}
                                                                                    ...
                                                                                    <CustomInput disabled={true} type="radio" id="formRadioOffer2" name="formRadio" label={this.state.offer_status == 'rejected' ? 'Rejected' :'Reject'}  checked={this.state.offer_status === "rejected"}
                                                                                        invalid={this.state.borderNew  && this.state.offer_status == "" ? true :false}
                                                                                        onClick={(e) =>
                                                                                        {
                                                                                            this.setState({
                                                                                ...
                                                                                <div style={{ display: 'inline-flex' ,marginTop:"-8px"}}>
                                                                                        <CustomInput disabled={true} type="radio" id="formRadio1" name="formRadio" label={this.state.interview_status == "selected" ? "Selected" :"Select"}  checked={this.state.interview_status === "selected"}
                                                                                        ...
                                                                                        <div style={{ width: '48px' }} />
                                                                                        <CustomInput disabled={true} type="radio" id="formRadio2" name="formRadio" label={this.state.interview_status == "rejected" ? "Rejected" :"Reject"}  checked={this.state.interview_status === "rejected"}
                                                                                            invalid={this.state.borderNew  && this.state.interview_status == "" ? true :false}
                                                                                            onClick={(e) =>
                                                                                            {
                                                                                                this.setState({
                                                                                        ...
                                                                                        <div style={{ width: '48px' }} />
                                                                                        <CustomInput disabled={true} type="radio" id="formRadio3" name="formRadio" label="On-Hold"  checked={this.state.interview_status === "on_hold"}
                                                                                            invalid={this.state.borderNew  && this.state.interview_status == "" ? true :false}
                                                                                            onClick={(e) =>
                                                                                            {
                                                                                                this.setState({
                                                                        ...
                                                                        {this.state.offerTab == "offer" ?
                                                                            <div className="col-lg-12">
                                                                                ...
                                                                                <div className="col-lg-6 col-md-6 col-xs-12 mt-15">
                                                                                        ...
                                                                                        <div>
                                                                                        <DatePicker
                                                                                            value={this.state.req_date_of_assigning}
                                                                                            disabled={true}
                                                                                            selected={this.state.req_date_of_assigning}
                                                                                            onChange={(val) => {
                                                                                            this.setState({
                                                                                                req_date_of_assigning: val,generate_error:""
                                                                                            });
                                                                                            }}
                                                                                ...
                                                                                <div className="col-lg-6 col-md-6 col-xs-12 mt-15" >
                                                                                    ...
                                                                                    <Select
                                                                                        value = {this.state.req_engagement_type}
                                                                                        isDisabled={true}
                                                                                        onChange={(e) => {
                                                                                            this.setState({
                                                                                                req_engagement_type: e,generate_error:"",is_type_update:true
                                                                                            });
                                                                                        }}
                                                                                        placeholder="Letter Template"
                                                                                        options={ engagement_type }
                                                                                        styles={ customStyles }
                                                                                        className={this.state.borderNew && this.state.req_engagement_type == "" ?  "is_not_valid" : "contact_sort"}
                                                                                        />
                                                                                    </div>
                                                                                <div className="col-lg-6 col-md-6 col-xs-12 mt-15">
                                                                                    ...
                                                                                    <Input
                                                                                        ...
                                                                                        placeholder="Salary"
                                                                                        invalid={this.state.borderNew  && this.state.req_salary_emp == "" ? true :false}
                                                                                        value={this.state.req_salary_emp}
                                                                                        onChange={(e) => {
                                                                                        this.setState({
                                                                                            req_salary_emp:e.target.value,generate_error:""
                                                                                        })
                                                                                ...
                                                                                <div className="col-lg-6 col-md-6 col-xs-12 mt-15">
                                                                                        ...
                                                                                        <Select
                                                                                        value={this.state.req_salary_structure_obj}
                                                                                        isDisabled={true}
                                                                                        options={tem_object}
                                                                                        styles={customStyles}
                                                                                        className={this.state.borderNew && this.state.req_salary_structure_obj == "" ?  "is_not_valid" : "contact_sort"}
                                                                                        onChange={(e) => {
                                                                                            this.setState({ req_salary_structure_obj: e,generate_error:""})
                                                                                            }}
                                                                                        />
                                                                                </div>
                                                                    ...
                                                                    <div className="col-lg-3 col-md-3 paddingRight30New">
                                                                      ...
                                                                      <div className="col-lg-12 paddingRight80New">
                                                                        ...
                                                                        //   console.log("reviewwwwwwwwwwwwww",value);
                                                                            return(
                   ...
                   <Modal
                     ...
                     >
                         <div className="modal-header">
                             ...
                             <div className=" suspended" style={{display:this.state.heading=="Add Employee" ? "none" :"inline-flex"}}>
                         ...
                         <div className="form rui-sign-form rui-sign-form-cloud">
                             ...
                             <div className="col-lg-4 col-md-4 col-xs-12 inputHeight">
                                     ...
                                     <div className="col-lg-12 col-md-12 col-xs-12 mt-15">
                                     <Label className="offerLabel" for="phone">Date of Birth<span className="start_mark">*</span></Label>
                                        <div className={this.state.borderNew  && (this.state.date_of_birth == "" || this.state.date_of_birth == null) ? "invalid_date_new " : ""}>
                                        <DatePicker
                                            ...
                                            invalid={this.state.borderNew  && (this.state.date_of_birth == "" || this.state.date_of_birth == null ) ? true :false}
                                        />
                                        </div>
                                        </div>
                                ...
                                <div className="col-lg-5 col-md-4 col-xs-12 inputHeight">
                                    ...
                                    <div className="col-lg-12 col-md-12 col-xs-12 mt-15" style={{display:this.state.heading=="Add Employee" ? "none" :"block"}}>
                                     <Label className="offerLabel"  for="phone">Employment ID<span className="start_mark">*</span></Label>
                                     <Input
                                         type="text"
                                         className="form-control"
                                         placeholder="Employment ID"
                                         value={this.state.employment_id}
                                         onChange={(e) => {
                                          this.setState({
                                         ...
                                         invalid={this.state.borderNew  && this.state.employment_id == "" ? true :false}
                               ...
                               />
                                 ...
                                 <div className="col-lg-12 col-md-12 col-xs-12 mt-15 suspended" style={{display:this.state.heading=="Add Employee" ? "none" :"inline-flex"}}>
                                  <Label for="phone">Suspend/Unsuspend</Label>
                                  <CustomInput type="switch" id="formSwitch1" name="formSwitch1"  defaultChecked={this.state.suspend_unsuspen==true ? true : false}  onClick={(e) => {
                                     this.setState({
                                         suspend_unsuspen: e.target.checked
                   ...
                   <Modal
                     ...
                     >
                         ...
                         <ModalFooter>
                             ...
                             { ' ' }
                             <Button color="brand" style={{backgroundColor:"#007bff" ,borderColor:"#007bff",textTransform:"capitalize"}} disabled={this.state.loading} onClick={ this.switch_function_for_engagement}>{this.state.button_for_engagement}{this.state.loading ? (
                                <Spinner />
                            ) : ''}</Button>
                         </ModalFooter>
                     </Modal>
                   ...
                   <Modal
                     ...
                     >
                         ...
                         <ModalFooter>
                             ...
                             { ' ' }
                             <Button color="brand" style={{backgroundColor:"#007bff" ,borderColor:"#007bff",textTransform:"capitalize"}} disabled={this.state.loading} onClick={ this.upload_document_engagement}>Save{this.state.loading ? (
                                <Spinner />
                            ) : ''}</Button>
                         </ModalFooter>
                     </Modal>
                 ...
                 >
                     <ModalBody>
                         ...
                         <Button color="secondary" style={{marginRight: "20px",textTransform:"capitalize"}} onClick={this.AlertDelete}>no</Button>
                             <Button color="warning no_btn" disabled={this.state.loading}
