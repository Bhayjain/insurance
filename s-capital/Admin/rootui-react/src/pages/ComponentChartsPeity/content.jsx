 ...
 class Content extends Component {
     constructor( props ) {
         ...
         this.state = {
            ...
            company_profit:false,
            check_payout:false,
            checked_policy:false,
         };
          this.fetch_detailed_pending_payment_report(undefined,undefined,undefined,"Pending",this.state.current_page)
        //  this.fetch_user_for_payout_details()
     ...
     toggleTab( num, name ) {
        ...
        if (name == "home") {
            ...
            this.fetch_detailed_pending_payment_report(undefined,undefined,undefined,"Paid",this.state.current_page)
        }
    ...
    //   Fetch Deatiled API
    // fetch_detailed_pending_payment_report = (startDate,endDate,pageNumber)=>  {
    ...
    //       const res = fetch(settings.api_url + "fetch_pending_payout", {
    //     //   const res = fetch(settings.api_url + "fetch_pending_payout", {
    //           method: 'POST',
    ...
    //           .then(json => {
    //             //  //console.log("fetch_pending_payout ****", json)
    //               var data = json;
    //               if (data.status == true) {
    //                   this.setState({
    //                       pending_payout_array: data.data,
    ...
    //   Fetch Deatiled API
    fetch_detailed_pending_payment_report = (sm_telli_direct_data,startDate,endDate,payout_status,pageNumber)=>  {

        //console.log("payout_status********",payout_status);
         ...
         this.setState({
            po_discount_status:payout_status
         })
         ...
         //console.log("Payoutssss Params",params);
         const { settings } = this.props;
          const res = fetch(settings.api_url + "fetch_user_for_payout_details", {
              method: 'POST',
              body: JSON.stringify(params),
              headers: {
                  "Content-type": "application/json; charset=UTF-8",
              ...
              .then(json => {
                 //console.log("fetch_user_for_payout_details ****", json)
                  var data = json;
                  if (data.status == true) {
                      this.setState({
                          pending_payout_array: data.data,
      ...
      show_validation_data =(files)=>{
        ...
        else if (this.state.mode_of_payment_label=="Cheque") {
      ...
      paid_pending_payment_policy = (files) => {
        ...
        if (this.state.mode_of_payment_label=="Cheque") {
        ...
        //console.log("company_profit", this.state.company_profit);
            ...
            fd.append('zero_profit', this.state.company_profit);
            fd.append('paid_by', JSON.stringify(paid_by));


        // headers: {'Content-Type': undefined}
       console.log(...fd, "paid_pending_payout_policy********************")

            const res = fetch(settings.api_url + "paid_pending_payout_policy", {
                method: 'POST',
                body: fd
            })
                .then((response) => response.json())
    ...
    fetch_catgory_wise_users = (user_type)=>  {
     ...
     toggleCheckbox=(e,value,index)=>{
        ...
        if (e.target.checked==true) {
                policy_amount_new = +value.section_details[0].po_discount_amount
    ...
    // console.log("VALUE",value);
        ...
        //     for(var i=0; i<policy_dis_array.length; i++){
        //     if(policy_dis_array[i].policy_id == name ){
        //         ////console.log("iiiiiii",i,1);
        //         policy_dis_array.splice(i, 1)
        //     //console.log(policy_dis_array,"kkkkkkkkkkkkkkkkkkkkkkkkk");
        //     }
        //     else{
        ...
        //     }
        //     this.setState({
        //         policy_dis_array:policy_dis_array
        //     })
                ...
                <PageTitle className="daily_heading">
                 <div className="row">
                  <div className="col-lg-6 col-md-12" style={{display:"inline-flex", width:"100%"}}>
                      <h1 style={{marginTop: "0px",marginRight:"30px"}}>Pending Payout&apos;s </h1>
                      <div style={{marginTop:"-5px"}}>
                      <Tabs pills className="payouts_tabs">
                        <Tabs.NavItem
                            isActive={ this.state.activeTab2 === 'home' }
                            onClick={ () => this.toggleTab( 2, 'home' ) }
                            className="pend_payout"
                        >
                            Pending Payout
                        </Tabs.NavItem>
                        <Tabs.NavItem
                  ...
                  <div className="col-lg-2 col-md-4 tpo_view" style={{width:"100%"}}>
                            ...
                            <div className="col-lg-2 col-md-4 tpo_view">
                  ...
                  <div className="col-lg-2 col-md-4 for_ipad_new tpo_view" style={{display: "inline-flex", width:"100%"}}>

                      <div className="date_pickerrr date_pickerrr_neww newwww">
                         <RangeDatePicker
                                     name="daterange"
                                     ...
                                     onChange={(startDate, endDate) => {
                                         ...
                                         this.fetch_detailed_pending_payment_report(this.state.sm_telli_direct_data,startDate,endDate,this.state.po_discount_status,this.state.current_page)
                                     }
                                     }
                     ...
                     <Tabs.Content activeTab={ this.state.activeTab2 }>
                        ...
                        <div className="row scroll_stop test_collapse" >
                             <div className="col-lg-3 col-md-12 col-sm-12 mycalendar" style={{height:my_height-69,display: this.state.ipad_emp_list,paddingRight: "0px"}}>
                             <div className="">
                                ...
                                <Table striped>
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" className="table_head_new">Head</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {this.state.pending_payout_array.map((value,index)=>{
                                                ...
                                                return(
                                                    ...
                                                    <th scope="row" style={{borderLeft:this.state.user_id_new == value._id ? "5px solid #8bc240" :""}} className="table_sub_head">
                                                        <div>{value.agent_name}</div>
                                                        <div className="type_new">{value.type}</div>
                                                    </th>
                                                    <td className="table_sub_head">{value.emp_relationship ? value.emp_relationship.label.split("-")[0]:""}</td>
                                                </tr>
                                                )
                                            })}
                            ...
                            <div className="col-lg-9 col-md-12 col-sm-12 test_collapse" style={{display: device_width < 769 ? this.state.ipad_width : "block",paddingLeft:"0px"}}>
                                ...
                                <div className="test_collapse pad_in_dar" style={{display:this.state.pending_spinner=="none" ? "block" : "none"}}>
                                            ...
                                            <div className="client_name row">
                                                    ...
                                                    <div className="col-lg-4 col-md-4">
                                                        <Button color="warning"  disabled={this.state.pending_payment_control == "false" || this.state.check_payout == false ? 'disabled' : ''} style={{color:"#fff",marginLeft: "auto",whiteSpace: "nowrap",textTransform: "capitalize"}} onClick={ this.toggle }>Make Payout</Button>
                            ...
                            <div className="col-lg-9 col-md-12 col-sm-12 test_collapse" style={{display: device_width < 769 ? this.state.ipad_width : "block",paddingLeft:"0px"}}>
                                ...
                                <div className="test_collapse pad_in_dar" style={{display:this.state.pending_spinner=="none" ? "block" : "none"}}>
                                            ...
                                            <div className="client_name row">
                                                    ...
                                                    <div className="col-lg-4 col-md-4">
                                                        {/* <Button color="warning"  disabled={this.state.pending_payment_control == "false" ? 'disabled' : ''} style={{color:"#fff",marginLeft: "auto",whiteSpace: "nowrap",textTransform: "capitalize"}} onClick={ this.toggle }>Make Payout</Button> */}
                                                            <Button className="" style={{ marginLeft: "5px",  backgroundColor: '#007bff', borderColor: '#007bff',textTransform:"capitalize", display: device_width < 769 ? "inline-flex" : "none"}}
                                                                            onClick={() => {
                                                                            this.setState({
                                                                                ipad_emp_list:"block",
                    ...
                    <div className="table-responsive-lg scroll_1 toooop_newww" style={{marginTop:"-20px"}}>
                         <Table striped>
                             <thead>
                              <tr>
                                {/* <th scope="col" className="table_head_new"></th> */}
                ...
                <Modal
                    ...
                    >
                        <div className="modal-header">
                            <h5 className="modal-title h2">Make Payout</h5>
                        ...
                        <ModalBody>
                            <div className="row">
                             ...
                             <div className="col-lg-12 col-md-12 col-sm-12" style={{display:this.state.mode_of_payment_label=="Cheque" ?"block" :"none"}}>
                                 <div className="row">
                                 <div className="col-lg-6 col-md-6 mar_top_new">
                                   ...
                                   <Input type="number" name="policy_no" id="emailInput1" placeholder="Cheque Amount"
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-12 mar_top_new">
                                <CustomInput type="checkbox" id="formCheckbox0121" label="0% Payout (Company Profit)"
                                onChange={(e) => {
                                    this.setState({
                                           company_profit:e.target.checked
                                    })
